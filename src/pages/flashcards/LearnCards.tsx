    ...
    <div className="min-h-screen bg-gradient-to-r from-gray-800 to-black text-white py-20">
      {filteredFlashcards.length > 0 ? (
        <div className="flex justify-center items-center">
          <div
            className={`w-[90%] sm:w-[80%] md:w-[70%] xl:w-[60%] p-6 sm:p-12 md:p-16 rounded-3xl shadow-xl transition-all ${
              isKnownWord
                ? "bg-green-500 border-8 border-green-700"
                : "bg-red-500 border-8 border-red-700"
            } flex flex-col items-center`}
          >
            <div className="flex justify-between items-center w-full mb-8 sm:mb-16">
              <button
                onClick={handlePrev}
                className="text-4xl sm:text-5xl text-white hover:text-gray-200 transition-all"
              >
                <FaArrowLeft />
              </button>
              <div
                onClick={handleWordClick}
                className="text-4xl sm:text-6xl font-semibold text-center cursor-pointer px-6"
              >
                {showTranslation
            ...
            <div className="mt-8 sm:mt-16 flex flex-row sm:flex-row justify-between items-center w-full text-xl sm:text-2xl">
              <button
                className="bg-green-700 text-white py-4 px-8 sm:py-4 sm:px-12 rounded-lg text-lg sm:text-2xl"
                onClick={() =>
              ...
              <button
                className="bg-red-700 text-white py-4 px-8 sm:py-4 sm:px-12 rounded-lg text-lg sm:text-2xl"
                onClick={() =>
...
<div className="flex flex-wrap justify-center mt-12 gap-6 sm:gap-8">
  <button
    value="LearnAll"
    onClick={() => handleClick("LearnAll")}
    className="bg-blue-600 text-white py-3 px-6 sm:py-4 sm:px-10 rounded-lg text-xl sm:text-2xl hover:bg-blue-500 transition-all ease-in-out duration-300"
  >
    Learn All
  </button>
  <button
    ...
    className="bg-yellow-600 text-white py-3 px-6 sm:py-4 sm:px-10 rounded-lg text-xl sm:text-2xl hover:bg-yellow-500 transition-all ease-in-out duration-300"
  >
    Learn Known
  </button>
  <button
    ...
    className="bg-gray-600 text-white py-3 px-6 sm:py-4 sm:px-10 rounded-lg text-xl sm:text-2xl hover:bg-gray-500 transition-all ease-in-out duration-300"
  >
    Learn UnKnown
  </button>
</div>
