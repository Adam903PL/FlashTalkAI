...
<div className="flex items-center gap-4">
  ...
  />
          ...
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg space-y-6">
            <h2 className="text-2xl font-semibold text-blue-400">Subscription Plan</h2>

            {!isPremium ? (
              Premium2 === true ? <>
                  <div className="flex flex-col items-center space-y-6">
              <p className="text-lg text-center text-green-400">You are already on the Premium plan!</p>
      <p className="text-sm text-gray-300">You can modify your credit card details by clicking below:</p>
...
/>
                           ...
                           <div className="flex flex-col items-center space-y-6">
                           <p className="text-lg text-center">Upgrade to Premium for just <span className="text-blue-400 font-bold">$10.99/month</span>!</p>
                           <ul className="text-sm text-gray-300 space-y-2">
                             <li className="flex items-center gap-2"><FaRegLightbulb className="text-yellow-400" /> More AI recommendations</li>
                             <li className="flex items-center gap-2"><FaRegLightbulb className="text-yellow-400" /> Personalized corrections</li>
                             <li className="flex items-center gap-2"><FaRegLightbulb className="text-yellow-400" /> Increased word limit</li>
                           </ul>
                           <button
                             onClick={handleUpgradeToPremium}
                           ...
                           >
                             Upgrade to Premium <FaArrowRight className="inline ml-2" />
                           </button>
                         </div> 
              ...
              <div className="text-center space-y-6">
                <h3 className="text-lg font-semibold text-green-400">Thank you for upgrading to Premium!</h3>
                <div className="space-y-4">
                  <h4 className="font-semibold text-blue-300">Credit Card Details</h4>
                  <div className="flex items-center gap-4">
